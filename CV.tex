...
%\textsc{Southwest Research Institute}, Boulder, CO & \textsc{Jan} 2014 \\
%{\it Dynamics and Consequences of Circumplanetary Debris Disks Around the Giant Planets} \\
%\\
%\textsc{Harvard-Smithsonian Center for Astrophysics, Cambridge, MA} & \textsc{Nov} 2013\\
%{\it A Dynamical Instability for Satellites around High-Obliquity Planets}  \\
%\\
%\textsc{Canadian Institute for Theoretical Astrophysics}, Toronto, ON & \textsc{Oct} 2013 \\
%{\it Dynamics and Consequences of Circumplanetary Debris Disks Around the Giant Planets} \\
%\\
%\textsc{American Museum of Natural History}, New York, NY & \textsc{May} 2013 \\
%{\it A Tale of Two Debris Disks: Chaos around Uranus \& Is Fomalhaut b a Planet?} \\
%\\
%\textsc{Berkeley Theoretical Astrophysics Center}, Berkeley, CA & \textsc{Dec} 2012 \\
%{\it Dynamics and Consequences of Circumplanetary Debris Disks Around the Giant Planets} \\
%\\
%\textsc{Rochester Institute of Technology}, Rochester, NY & \textsc{Mar} 2012 \\
%{\it Painting the Giant Planets' Regular Satellites} \\
%\end{tabular}
